...
export default class Password{
    /** 
    * @description
    * <div class="exapmle" data-module="password" data-example='[{"all":"420-940"}]'></div>
    ...
    * @property {boolean}  showPassword              - 		Defines whether the elements to hide and display can switch.
